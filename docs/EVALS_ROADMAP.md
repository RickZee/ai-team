# Evals Roadmap (aspirational)

Content moved from `docs/EVALS.md` during eval-harness Phase 10. These paths and role-eval suites are **not** part of the v1 harness gate.
