...
- Make the capstone highly demonstrable: include the FastAPI + React web dashboard (`ai-team-web`) for input, demo videos/scripts, multiple example projects (simple → complex).
