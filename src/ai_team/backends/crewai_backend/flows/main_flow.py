...
from ai_team.core.flow_wiring import register_flow_class
...
def _parse_planning_output(
    ...
    """
    from ..agents.product_owner import _dict_to_requirements_document
...
class AITeamFlow(Flow[ProjectState]):
    ...
    def run_planning_crew(self) -> dict[str, Any]:
        ...
        try:
            from ..crews.planning_crew import kickoff as planning_crew_kickoff
    ...
    def run_development_crew(self) -> dict[str, Any]:
        ...
        try:
            ...
            from ..crews.development_crew import kickoff as development_crew_kickoff
    ...
    def run_testing_crew(self) -> dict[str, Any]:
        ...
        try:
            ...
            from ..crews.testing_crew import kickoff as testing_crew_kickoff
    ...
    def run_deployment_crew(self) -> dict[str, Any]:
        ...
        try:
            from ..crews.deployment_crew import DeploymentCrew, package_output
...
register_flow_class(AITeamFlow)
